...
export default class StoryUpdate extends Vue{
  story: StoryDTO = {id: 2, name: "bla bla bla", description: "This zaeaezez", creationDate: "2021-02-09", userId: 2}
...
<template>
  <form action="">
    ...
    <textarea v-model="story.description" name="story_description" id="story_description" cols="50" rows="30"></textarea><br>

    <button @click="updateStory">Mettre à jour l'histoire</button>
